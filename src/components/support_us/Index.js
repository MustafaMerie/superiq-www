      ...
      <Container>
        <Row className="justify-content-between">
          <Col id="support_us" xs={11} lg={4} className="support_us_box">
            ...
            <p>
              اضغط على الزر ادناه وشاركنا بالطريقة الي تفضل ان نتواصل بيها وياك
              وكذلك وصف عن شنو هو نوع الدعم الي حاب ان تقدمه للمنحة وراح نتواصل
              وياك بعد ان يوصلنا ارسالك
            </p>
            <a
              className="link"
              href="https://forms.gle/zTUpFYQtfNnN9vnn6"
              target="_blank"
              rel="noreferrer"
            >
              املئ استمارة الدعم
          ...
          <Col id="apply_now" xs={11} lg={4} className="support_us_box">
            ...
            <p>
              املأ استمارة التقديم بالضغط على الزر ادناه، وحتى تزيد من فرصتك ان
            ...
            <a
              className="link"
              href="https://forms.gle/HVsZXkXGqr2E2zsd8"
              target="_blank"
              rel="noreferrer"
            >
              املئ استمارة التقديم
            </a>
            <p>{/* <small>.باقي ٢ يوم على انتهاء فترة التقديم</small> */}</p>
          </Col>
        </Row>
